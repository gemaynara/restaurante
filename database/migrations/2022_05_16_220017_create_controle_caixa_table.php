...
class CreateControleCaixaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('controle_caixa', function (Blueprint $table) {
            ...
            $table->decimal('saldo_cartao', 11,2)->default(0.00);
            $table->decimal('saldo_dinheiro', 11,2)->default(0.00);
            $table->decimal('saldo_pix', 11,2)->default(0.00);
            $table->decimal('saldo_outros', 11,2)->default(0.00);
