                ...
                <div class="collapse" id="delivery">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"><a class="nav-link" href="pages/samples/login.html">Horário de
                                Funcionamento </a></li>
                        <li class="nav-item"><a class="nav-link" href="pages/samples/login.html">Cardápio Mobile </a>
                        </li>
                    </ul>
                </div>
            </li>
        ...
        @can('estoque')
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="notes">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"><a class="nav-link" href="{{route('fornecedores.index')}}">Fornecedores</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{route('notas-fiscais.index')}}">Notas
                                Fiscais</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{route('saidas.index')}}">Saída de Produtos</a>
                        </li>
                    </ul>
                </div>
            </li>
