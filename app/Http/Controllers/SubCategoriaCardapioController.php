...
class SubCategoriaCardapioController extends Controller
{
    ...
    public function index()
    {
        $subcategorias = SubCategoriaCardapio::query()
            ->with(['categoriaCardapio' => function ($query) {
    ...
    {
        $categorias = CategoriaCardapio::where('empresa_id', auth()->user()->empresa->id)
            ->orderBy('nome', 'asc')
            ->get();
    ...
    public function edit($id)
    {
        ...
        $categorias = CategoriaCardapio::query()->where('empresa_id', auth()->user()->empresa->id)
            ->orderBy('nome', 'asc')
            ->get();
